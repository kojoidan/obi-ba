  ...
  return (
    <div className='relative'>
        ...
        <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            ...
            Freshness You Can Trust, Affordable You Will Love!</h1>
        

        <div className='flex items-center mt-6 font-medium gap-6'>
            <Link to={"/products"} className='group flex items-center gap-2 px-7 py-3
            bg-yellow-600 hover:bg-yellow-400 transition rounded text-white cursor-pointer'>
            Orde now
            <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow" />
            </Link>

            <Link to={"/products"} className='hidden md:flex items-center gap-2 px-7 py-3
            bg-yellow-600 hover:bg-yellow-400 transition rounded text-white cursor-pointer'>
            View more
